...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A1F2C] via-[#1A1F2C] to-[#2D1B4E]">
      <nav className="fixed top-0 w-full bg-[#1A1F2C]/80 backdrop-blur-lg border-b border-white/10 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-white">Альвандрес</span>
          </div>
          <div className="hidden md:flex gap-8">
            <a href="#services" className="text-gray-300 hover:text-primary transition-colors">Услуги</a>
            <a href="#editors" className="text-gray-300 hover:text-primary transition-colors">Редакторы</a>
            <a href="#about" className="text-gray-300 hover:text-primary transition-colors">О нас</a>
      ...
      <section id="services" className="py-20 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-5xl font-bold text-white mb-4">Наши услуги</h2>
            <p className="text-xl text-gray-300">Всё для создания вашего издания</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <Card 
                key={index} 
                className="bg-card/50 backdrop-blur border-white/10 hover:border-primary/50 transition-all duration-300 hover:transform hover:scale-105 group animate-fade-in"
      ...
      <section id="editors" className="py-20 px-6 bg-[#1A1F2C]/50">
        <div className="container mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-5xl font-bold text-white mb-4">Наши редакторы</h2>
            <p className="text-xl text-gray-300">Профессионалы своего дела</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {editors.map((editor, index) => (
              <Card 
                key={index} 
                className="bg-card/50 backdrop-blur border-white/10 hover:border-primary/50 transition-all duration-300 overflow-hidden group animate-slide-in-left"
              ...
              >
                ...
                <CardContent className="p-6 -mt-16 relative z-10">
                  <h3 className="text-2xl font-bold text-white mb-1">{editor.name}</h3>
                  <p className="text-primary font-medium mb-2">{editor.role}</p>
                  <p className="text-gray-400 mb-4">{editor.specialization}</p>
      ...
      <section id="about" className="py-20 px-6">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <h2 className="text-5xl font-bold text-white mb-6">О издательстве</h2>
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                <strong className="text-white">Альвандрес</strong> — современное издательство полного цикла, 
              ...
              <div className="grid grid-cols-3 gap-6 mt-8">
                <div className="text-center">
                  ...
                  <div className="text-gray-400">Изданий</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-secondary mb-2">15</div>
                  <div className="text-gray-400">Редакторов</div>
                </div>
                <div className="text-center">
            ...
            <div className="animate-scale-up">
              <Card className="bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur border-primary/20 p-8">
                <CardContent className="space-y-6 p-0">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Редакторы с многолетним опытом работы</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-white mb-2">Быстрые сроки</h3>
                      <p className="text-gray-300">Работаем оперативно без потери качества</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Полное сопровождение на всех этапах</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section id="contact" className="py-20 px-6 bg-[#1A1F2C]/50">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-5xl font-bold text-white mb-4">Свяжитесь с нами</h2>
            <p className="text-xl text-gray-300">Готовы обсудить ваш проект</p>
          </div>
          <Card className="bg-card/50 backdrop-blur border-white/10 animate-scale-up">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white font-medium">info@alvandres.ru</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white font-medium">Москва, ул. Литературная, 10</div>
                    </div>
                  </div>
                </div>
      ...
      <footer className="py-8 px-6 border-t border-white/10">
        <div className="container mx-auto text-center text-gray-400">
          <p>© 2024 Издательство Альвандрес. Все права защищены.</p>
        </div>
      </footer>
    </div>
  );
